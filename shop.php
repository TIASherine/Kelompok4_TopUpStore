        ...
        <div class="checkout-form">
            ...
            <form id="paymentForm" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="playerId" name="playerId" placeholder="Masukkan ID Player Anda" required
                        value="<?php echo isset($_POST['playerId']) ? htmlspecialchars($_POST['playerId']) : ''; ?>">
                </div>

                <div class="form-group">
                    <label for="playerName">Nama Player</label>
                    <input type="text" id="playerName" name="playerName" placeholder="Masukkan Nama Player Anda"
                        required
